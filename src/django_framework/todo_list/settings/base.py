...
APPS_DIR = BASE_DIR / "todo_list" / "apps"
...
LOCAL_APPS: List[str] = [
    "todo_list.apps.users.apps.UsersConfig",
]
DJANGO_APPS = [
...
ROOT_URLCONF = "todo_list.config.urls"
...
WSGI_APPLICATION = "todo_list.config.wsgi.application"
